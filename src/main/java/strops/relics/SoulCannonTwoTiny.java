...
public class SoulCannonTwoTiny extends StropsAbstractRelic implements ClickableRelic {
    public static final String ID = ModHelper.makePath(SoulCannonTwoTiny.class.getSimpleName());
    private static final String IMG_PATH = ModHelper.makeIPath(SoulCannonTwoTiny.class.getSimpleName());
    ...
    public static final int NUM1=2,NUM2=10,NUM3=12,NUM4=14,NUM5=18;

    public static final IntSliderSetting COST=new IntSliderSetting("TwoTiny_Cost", "N1", NUM1, 1,10);
    public static final IntSliderSetting ACT1=new IntSliderSetting("TwoTiny_Act1", "N2", NUM2, 10,50);
    public static final IntSliderSetting ACT2=new IntSliderSetting("TwoTiny_Act2", "N3", NUM3, 12,60);
    public static final IntSliderSetting ACT3=new IntSliderSetting("TwoTiny_Act3", "N4", NUM4, 14,70);
    public static final IntSliderSetting ACT4=new IntSliderSetting("TwoTiny_Act4", "N5", NUM5, 18,90);
    ...
    public void cannonShoot(AbstractCreature enemy){
        ...
        addToTop(new LoseHPAction(p, p, COST.value));
    ...
    public AbstractRelic makeCopy() {return new SoulCannonTwoTiny();}
}
