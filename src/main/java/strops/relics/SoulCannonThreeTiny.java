...
import strops.actions.LoseMaxHpAction;
import strops.cards.*;
...
public class SoulCannonThreeTiny extends StropsAbstractRelic implements ClickableRelic {
    public static final String ID = ModHelper.makePath(SoulCannonThreeTiny.class.getSimpleName());
    private static final String IMG_PATH = ModHelper.makeIPath(SoulCannonThreeTiny.class.getSimpleName());
    //private static final String IMG_PATH_O = ModHelper.makeOPath(SoulCannonOneTiny.class.getSimpleName());
    private static final RelicTier RELIC_TIER = RelicTier.SPECIAL;
    private static final LandingSound LANDING_SOUND = LandingSound.HEAVY;

    public static final int NUM1=1,NUM2=10,NUM3=12,NUM4=14;

    public static final IntSliderSetting COST=new IntSliderSetting("ThreeTiny_Cost", "N1", NUM1, 1,5);
    public static final IntSliderSetting ACT1=new IntSliderSetting("ThreeTiny_Act1", "N2", NUM2, 10,50);
    public static final IntSliderSetting ACT2=new IntSliderSetting("ThreeTiny_Act2", "N3", NUM3, 12,60);
    public static final IntSliderSetting ACT3=new IntSliderSetting("ThreeTiny_Act3", "N4", NUM4, 14,70);
    //public static final IntSliderSetting ACT4=new IntSliderSetting("ThreeTiny_Act4", "N5", NUM5, 18,90);
    ...
    public void cannonShoot(AbstractCreature enemy){
        ...
        addToTop(new LoseMaxHpAction(COST.value));
    ...
    public AbstractRelic makeCopy() {return new SoulCannonThreeTiny();}
}
