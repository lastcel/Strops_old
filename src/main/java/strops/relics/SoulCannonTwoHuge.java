...
public class SoulCannonTwoHuge extends StropsAbstractRelic implements ClickableRelic {
    public static final String ID = ModHelper.makePath(SoulCannonTwoHuge.class.getSimpleName());
    private static final String IMG_PATH = ModHelper.makeIPath(SoulCannonTwoHuge.class.getSimpleName());
    ...
    public static final int NUM1=8,NUM2=40,NUM3=48,NUM4=56,NUM5=72;
    ...
    public static final IntSliderSetting ACT4=new IntSliderSetting("TwoHuge_Act4", "N5", NUM5, 36,108);
    ...
    public AbstractRelic makeCopy() {return new SoulCannonTwoHuge();}
}
